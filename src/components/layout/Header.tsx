        ...
        <header className="fixed top-0 w-full z-50 backdrop-blur-md border-b dark:bg-black/80 bg-white/80 dark:border-gray-800/50 border-gray-200/50 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden sm:block scale-[0.5] origin-right -mr-6">
                    ...
                    <Link
                        href="#contact"
                        className="hidden sm:flex items-center gap-2 hover:gap-3 transition-all duration-300 group text-xs font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 rounded-full py-2.5 px-5 shadow-lg hover:shadow-purple-500/25"
                    >
