...
void main() {
    ...
    if (t > 0.0) {
        ...
        gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); // Black background for difference/exclusion blend mode
    }
}
`;
...
export const LavaLamp = () => {
    return (
        <div className="w-full h-full absolute top-0 left-0 bg-white dark:bg-black transition-colors duration-500">
