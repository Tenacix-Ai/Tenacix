...
const servicesData: ServiceCardData[] = [
  {
    ...
    title: 'Web\nScalability',
    shortDescription:
      'Plan-driven engineering for massive growth. Instant, secure, and infinitely scalable digital environments.',
    fullDescription: [
  ...
  },
  {
    ...
    title: 'AI\nAgents',
    shortDescription:
      'Change-driven autonomous workflows. Deploy custom LLMs to handle complex decision-making 24/7.',
    fullDescription: [
