...
const responses: Record<string, string> = {
  ...
  contact: 'Reach us at vrtxbuisness@gmail.com or use the "Book a Call" button above.',
  ai: 'We build AI agents that automate workflows, handle decisions, and integrate with your existing systems seamlessly.',
  website: 'We craft high-performance websites with premium animations and optimized conversions.',
  appointment:
  ...
  book: 'Ready to start? Click "Book a Call" or email vrtxbuisness@gmail.com.',
  call: 'Schedule a call via the "Book a Call" button or email vrtxbuisness@gmail.com.',
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-3 border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50 dark:bg-black">
              ...
              <p className="text-[10px] text-neutral-400 text-center mt-2">Powered by TENACIX</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
